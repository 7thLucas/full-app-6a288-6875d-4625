...
export function AscendForgotPasswordCard() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12" style={{ backgroundColor: "#111111" }}>
      ...
      <div className="w-full max-w-sm rounded-xl p-6" style={{ backgroundColor: "#1A1A1A", border: "1px solid rgba(201,168,106,0.15)" }}>
        <h1 className="text-xl font-bold mb-1" style={{ color: "#F5E9DC" }}>Reset Password</h1>
        <p className="text-sm mb-6" style={{ color: "#9E9E9E" }}>Enter your email and we'll send a reset link.</p>

        {actionData?.success && (
          <div className="mb-4 rounded-lg px-4 py-3 text-sm" style={{ backgroundColor: "rgba(201,168,106,0.1)", color: "#C9A86A", border: "1px solid rgba(201,168,106,0.2)" }}>
            {actionData.message}
          </div>
        )}
